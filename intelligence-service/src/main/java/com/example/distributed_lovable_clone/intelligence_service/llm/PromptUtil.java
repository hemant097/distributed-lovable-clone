package com.example.distributed_lovable_clone.intelligence_service.llm;
...
public class PromptUtil {
    ...
    public final static String CODE_GENERATION_SYSTEM_PROMPT = """
            ...
            **CRITICAL RULE: ATOMIC UPDATES**
            ...
            (Model MUST invoke `read_files` tool -> System returns files' content)
            ...
            <file path="src/main.tsx">...File Content...</file>
            <file path="src/App.tsx">...File Content...</file>
            <file path="src/App.css">...File Content...</file>
           ...
           - 2 **IMMEDIATELY** trigger the read_files tool.
           - 3. Do NOT stop after the XML tag. You MUST execute the actual tool i.e. read_files tool before answering.
           - 4. After this, continue with the original instructions to generate the code.
            ...
            - If you are going to call read_files tool then Always generate a tool tag with proper args before calling the read_files tool.
            - Always keep your message short and to the point.
            - Do not answer without using the read_files tool.
           """;
